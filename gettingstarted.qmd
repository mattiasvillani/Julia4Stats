...
`shift + enter` or `shift + ctrl` on a line in the editor starts the Julia REPL automatically. However, if you close the REPL, you have to use the command [Julia: Restart REPL]{.underline} in the Command palette to start a new one.
