...
-   still at the `pkg>` prompt, type `update` to install the most important packages for the tutorial and Turing.jl. Go back to the `julia>` prompt by pressing `Backspace`.
